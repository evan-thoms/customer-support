        ...
        <section className="container m-auto flex bg-Cararra justify-center items-center gap-20 h-screen">
            ...
            <article className="py-20 self-start">
                <form className="flex flex-col gap-4 mb-10">
                    <input className="w-96 px-4 h-11 mb-4 rounded" type="text" placeholder="First Name" />
                    <input className="w-96 px-4 h-11 mb-4 rounded" type="text" placeholder="Last Name" />
                    <input className="w-96 px-4 h-11 mb-4 rounded" type="email" placeholder="Email" />
                    <input className="w-96 px-4 h-11 rounded" type="password" placeholder="Password" />
                    <input className="w-96 px-4 h-11 rounded mb-2" type="password" placeholder="Confirm Password" />
                    <div className="flex items-center mb-6 justify-between">
                        <div className="flex gap-2">
                            <input type="checkbox" id="rememberpwd" name="rememberpwd" />
                            <label className="text-sm" for="rememberpwd">I accept the terms and conditions</label>
                        </div>
                    </div>
