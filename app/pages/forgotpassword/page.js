            ...
            <section className="container m-auto flex bg-Cararra justify-center items-center gap-20 h-screen">
                <article className="py-20 flex flex-col  text-black">
                    ...
                    <div className="mb-6 flex">
                        <p className=" text-bold px-3">No worries! <br/><br/> <span>We will get you back on track in no time!</span></p>
                ...
                <article className="py-20 self-start">
                    <form className="flex flex-col gap-4 mb-10">
                        <input className="w-96 px-4 h-11 rounded" type="email" placeholder="Email" />
